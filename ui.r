                   ...
                   tabPanel("Table Data",
                            ...
                            # Sidebar
                              sidebarPanel(
                                ...
                                sliderInput('forest', 'Forest area (% of land area)', min=0, max=100, value=c(25,50), step=5),
                                sliderInput('pop', 'Population growth (annual %)', min=-3, max=11, value=c(-3,11), step=0.5),
                                sliderInput('urbanPop', 'Urban population (% of total)', min=0, max=100, value=c(10,90), step=5),
                            ...
                            mainPanel(
                              tabsetPanel(
                                ...
                                tabPanel(p(icon("bar-chart"), "Summary"),
